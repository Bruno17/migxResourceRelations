...
$rrsortby = $modx->getOption('rrsortby', $scriptProperties, '');
$rrsortdir = $modx->getOption('rrsordir', $scriptProperties, 'ASC');
...
if (!empty($rrsortby) && $element == 'getResources') {
    $scriptProperties['sortby'] = 'FIELD(modResource . id, '.$output.')';
    $scriptProperties['sortdir'] = $rrsortdir;
}
